...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    ...
    Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `${$$result.head += `<!-- HEAD_svelte-zkbpcm_START -->${$$result.title = `<title>How good was it really?</title>`, ""}<meta name="description" content="Movie rater"><meta name="description" content="Movie rating"><meta name="description" content="Get my movie rating"><meta name="description" content="How good was x"><!-- HEAD_svelte-zkbpcm_END -->`, ""}
<div class="w-screen min-h-screen bg-gradient-to-r from-teal-200 to-lime-200"><div class="flex container w-full h-full mx-auto px-2">${slots.default ? slots.default({}) : ``}</div></div>`;
    });
  }
});
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.47942946.js", "_app/immutable/chunks/index.8201ef28.js"];
    stylesheets = ["_app/immutable/assets/0.4f4ae5ea.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.21953e6f.js", "_app/immutable/chunks/index.8201ef28.js", "_app/immutable/chunks/singletons.65f1bcd7.js", "_app/immutable/chunks/index.155317fc.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var selectedOption, options2, Infographic, css, Context, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    ...
    options2 = writable([]);
    Infographic = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let details = null;
      selectedOption.subscribe(async (value) => {
        if (value) {
          const resp = await fetch(`http://www.omdbapi.com/?apikey=cfebe6e7&i=${value.imdbID}&type=episode`);
      ...
      return `<div class="flex flex-col justify-center items-center mt-12">${details && details?.Poster !== "N/A" ? `${details?.Ratings?.length > 0 ? `<div class="text-left rounded bg-gradient-to-br mb-2 from-teal-300 to-lime-300 p-1 shadow-md">${each(details.Ratings, (rating) => {
        return `<div class="font-bold">${escape(rating.Source)}: ${escape(rating.Value)}</div>`;
      })}</div>` : ``}
    <img${add_attribute("src", details.Poster, 0)} width="160vw" height="auto" class="rounded" alt="Movie poster">` : ``}</div>`;
    });
    css = {
      code: ".ui.svelte-1b3i4ka *{box-sizing:border-box}.ui.svelte-1b3i4ka .visually-hidden{clip:rect(0 0 0 0);clip-path:inset(50%);height:1px;overflow:hidden;position:absolute;white-space:nowrap;width:1px}.ui.svelte-1b3i4ka .label{font-weight:bold}.ui.svelte-1b3i4ka .icon{width:24px;height:24px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}",
      map: null
    };
    Context = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css);
      return `<div class="ui svelte-1b3i4ka">${slots.default ? slots.default({}) : ``}
</div>`;
    });
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_options = subscribe(options2, (value) => $options = value);
      selectedOption.subscribe((value) => {
        if (value)
          searchStr = value.Title;
      });
      searchStr = "";
      isListOpen = $options.length > 0;
      focusedIndex = -1;
      $$unsubscribe_options();
      return `<div class="flex-1 text-center my-16"><h1 class="text-5xl font-extrabold text-gray-800">How good was it really?</h1>
  <div class="text-gray-500 font-bold">Search for your favorite movie or tv series and see the rating
  </div>
  <div class="flex flex-col mt-12 mx-auto">${validate_component(Context, "Context").$$render($$result, {}, {}, {
        default: () => {
          return `<input class="tracking-wider shadow-sm px-4 py-2 rounded-full w-full text-center" type="text" autocapitalize="none" autocomplete="off" placeholder="Title of movie or show" spellcheck="false" aria-autocomplete="list"${add_attribute("value", searchStr, 0)}>
      ${``}
      ${isListOpen ? `<ul class="shadow-lg list-none m-0 min-w-full overflow-y-auto z-50 rounded" role="listbox">${each($options, (listOption, index4) => {
            return `<li${add_attribute("id", listOption.imdbID, 0)}${add_attribute("class", clsx_m_default("hover:bg-green-300 text-xl font-bold text-gray-800 flex justify-center items-center py-1 hover:cursor-pointer", focusedIndex === index4 && "bg-green-300"), 0)}>${escape(listOption.Title)}
            </li>`;
          })}</ul>` : ``}`;
        }
      })}</div>
  ${!isListOpen ? `${validate_component(Infographic, "Infographic").$$render($$result, {}, {}, {})}` : ``}</div>`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    imports3 = ["_app/immutable/nodes/2.521a4d9a.js", "_app/immutable/chunks/index.8201ef28.js", "_app/immutable/chunks/index.155317fc.js"];
    stylesheets3 = ["_app/immutable/assets/2.4e1846e8.css"];
    fonts3 = [];
  }
});
...
var manifest = {
  ...
  _: {
    client: { "start": "_app/immutable/entry/start.1a36e296.js", "app": "_app/immutable/entry/app.498f2c82.js", "imports": ["_app/immutable/entry/start.1a36e296.js", "_app/immutable/chunks/index.8201ef28.js", "_app/immutable/chunks/singletons.65f1bcd7.js", "_app/immutable/chunks/index.155317fc.js", "_app/immutable/entry/app.498f2c82.js", "_app/immutable/chunks/index.8201ef28.js"], "stylesheets": [], "fonts": [] },
    nodes: [
